                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="app-border-2">
                            ...
                            <td>
                                <div class="mr-4 w-8 h-8 rounded-md flex items-center justify-center app-bg-blue-2 app-color-blue-1 text-lg font-semibold">1</div>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <svg
  class="w-6 h-6 app-color-blue-3"
  fill="none"
  stroke="currentColor"
  viewBox="0 0 24 24"
  xmlns="http://www.w3.org/2000/svg"
  onClick={toggleDropdown} // Add the onClick handler to open the dropdown
>
...
{isDropdownVisible && (
  <div  className="absolute top-12 right-0 mt-2">
    <ul className="bg-white border rounded-lg shadow-lg">
      ...
      >
      <Link style={{textDecoration:"none ",color:'black'}}  to={'/patienthome'}> Wait</Link>
      </li>
      <li
        className="cursor-pointer px-4 py-2 hover:bg-gray-200"
        onClick={() => handleOptionClick('Option 2')}
      >
        <Link style={{textDecoration:"none ",color:'black'}} to={'/users/new'}>Reschedule</Link> 
      ...
      <li 
        ...
        onClick={() => handleOptionClick('Option 1')}
      >
        <Link style={{textDecoration:"none ",color:'black'}} to={'/users/new'}>Search for a different hospital</Link> 
      </li>
    </ul>
  </div>
)}
                          ...
                          <tr class="app-border-1">
                            ...
                            <td>
                                <div class="mr-4 w-8 h-8 rounded-md flex items-center justify-center app-bg-yellow-2 app-color-yellow-1 text-lg font-semibold">2</div>
                            </td>
                            <td>
                                <div class="flex flex-row items-center py-3">
      ...
      >
        <Link style={{textDecoration:"none ",color:'black'}} to={'/users/new'}>Search for a different hospital</Link> 
                          ...
                          <tr class="app-border-1">
                            ...
                            <td>
                                <div class="mr-4 w-8 h-8 rounded-md flex items-center justify-center app-bg-blue-2 app-color-blue-1 text-lg font-semibold">3</div>
                            </td>
                            <td>
                                <div class="flex flex-row items-center py-3">
      ...
      >
        <Link style={{textDecoration:"none ",color:'black'}} to={'/users/new'}>Search for a different hospital</Link> 
                          ...
                          <td>
                            ...
                            <td>
                                <div class="flex justify-center items-center rounded-md w-8 h-8 app-bg-yellow-2 app-color-yellow-1 text-lg font-semibold">4</div>
                            </td>
                            <td>
