                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr class="app-border-2">
                            ...
                            <td>
                                <span class="h-8 w-28 font-semibold text-sm  flex items-center app-color-gray-1 justify-center app-color rounded-md">REGULAR</span>
                            </td>
                            <td>
                                <span class="font-semibold text-sm app-color-gray-1">04:10PM</span>
                            </td>
                            <td>
